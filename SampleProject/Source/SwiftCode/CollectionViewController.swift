...
extension CollectionViewController {
  ...
  func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
    ...
    let totalInteritemSpacing = (1 * collectionViewFlowLayout.minimumInteritemSpacing)
    let totalSectionInset = collectionViewFlowLayout.sectionInset.left + collectionViewFlowLayout.sectionInset.right
    let size = (collectionView.bounds.width - (totalSectionInset + totalInteritemSpacing)) / 2
